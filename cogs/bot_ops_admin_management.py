...
class BotOperations(commands.Cog):
    ...
    async def on_interaction(self, interaction: discord.Interaction):
        ...
        if custom_id == "alliance_control_messages":
            try:
                ...
                embed = discord.Embed(
                    title=f"{pimp.messageIcon} Alliance Control Messages Settings",
                    description=f"Alliance Control Information Message is Currently {'On' if current_value == 1 else 'Off'}",
                    color=pimp.emColor3 if current_value == 1 else pimp.emColor2
                )
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} An error occurred while managing alliance control messages.",
                        ephemeral=True
                    )
            ...
            try:
                ...
                if not result or result[0] != 1:
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} Only global administrators can manage control settings.", 
                        ephemeral=True
                    )
                    return
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} An error occurred while opening control settings.",
                        ephemeral=True
                    )
                ...
                if custom_id == "assign_alliance":
                    try:
                        with sqlite3.connect('db/settings.sqlite') as settings_db:
                            ...
                            if not admins:
                                await interaction.response.send_message(
                                    f"{pimp.deniedIcon} No administrators found.", 
                                    ephemeral=True
                                )
                                return
                            ...
                            for admin_id, is_initial in admins:
                                ...
                                admin_options.append(
                                    discord.SelectOption(
                                        ...
                                        emoji=f"{pimp.avatarOldIcon}" if is_initial == 1 else f"{pimp.avatarIcon}"
                                    )
                                )

                            admin_embed = discord.Embed(
                                title=f"{pimp.avatarIcon} Admin Selection",
                                description=(
                                    ...
                                    async def alliance_callback(alliance_interaction: discord.Interaction):
                                        try:
                                            ...
                                            with sqlite3.connect('db/settings.sqlite') as settings_db:
                                                ...
                                                if cursor.fetchone()[0] > 0:
                                                    ...
                                                    await alliance_interaction.response.send_message(
                                                        f"{pimp.deniedIcon} This administrator is already assigned to this alliance.",
                                                        ephemeral=True
                                                    )
                                                    return
                                                ...
                                                try:
                                                    ...
                                                    if "UNIQUE constraint failed" in str(e):
                                                        ...
                                                        await alliance_interaction.response.send_message(
                                                            f"{pimp.deniedIcon} An error occurred while assigning the alliance.",
                                                            ephemeral=True
                                                        )
                                                    return
                                            ...
                                            success_embed = discord.Embed(
                                                title=f"{pimp.verifiedIcon} Alliance Assigned",
                                                description=(
                                                    f"Successfully assigned alliance to administrator:\n\n"
                                                    f"{pimp.avatarIcon} **Administrator:** {admin_name}\n"
                                                    f"{pimp.fidIcon} **Admin ID:** {selected_admin_id}\n"
                                                    f"{pimp.allianceIcon} **Alliance:** {alliance_name} (**ID:** {selected_alliance_id})"
                                                ),
                                                color=pimp.emColor3
                                            )
                    ...
                    try:
                        ...
                        try:
                            ...
                            success_embed = discord.Embed(
                                title=f"{pimp.verifiedIcon} Administrator Successfully Added",
                                description=(
                                    f"### **New Administrator Information**\n"
                                    f"{pimp.divider1}\n\n"
                                    f"{pimp.avatarIcon} **Name:** {new_admin.name}\n"
                                    f"{pimp.fidIcon} **Discord ID:** {new_admin.id}\n"
                            ...
                            await interaction.edit_original_response(
                                content=f"{pimp.deniedIcon} Timeout No user has been tagged.",
                                embed=None
                            )
                        ...
                        if not interaction.response.is_done():
                            await interaction.response.send_message(
                                f"{pimp.deniedIcon} An error occurred while adding an administrator.",
                                ephemeral=True
                            )
                    ...
                    try:
                        ...
                        if not admins:
                            await interaction.response.send_message(
                                f"{pimp.deniedIcon} No administrator registered in the system.", 
                                ephemeral=True
                            )
                            return

                        admin_select_embed = discord.Embed(
                            title=f"{pimp.avatarIcon} Administrator Deletion",
                            description=(
                        ...
                        async def admin_callback(select_interaction: discord.Interaction):
                            try:
                                ...
                                info_embed = discord.Embed(
                                    title=f"{pimp.warnIcon} Administrator Deletion Confirmation",
                                    description=(
                                        f"### **Administrator Information**\n"
                                        f"{pimp.divider1}\n\n"
                                        f"{pimp.avatarIcon} **Name:** {admin_name}\n"
                                        f"{pimp.fidIcon} **Discord ID:** {selected_admin_id}\n"
                                        f"{'{pimp.avatarOldIcon} **Access Level:** Global Admin' if admin_info[1] == 1 else '{pimp.avatarIcon} **Access Level:** Server Admin'}\n"
                                        f"{pimp.allianceIcon} **Access Type:** {'All Alliances' if admin_info[1] == 1 else 'Server + Special Access'}\n"
                                        f"{pimp.listIcon} **Available Alliances:** {len(alliance_names)}\n\n"
                                        "{pimp.divider1}\n"
                                    ),
                                    color=pimp.emColor4
                                )
                                ...
                                if alliance_names:
                                    info_embed.add_field(
                                        name=f"{pimp.allianceIcon} Alliances Authorized",
                                ...
                                async def confirm_callback(button_interaction: discord.Interaction):
                                    try:
                                        ...
                                        success_embed = discord.Embed(
                                            title=f"{pimp.verifiedIcon} Administrator Deleted Successfully",
                                            description=(
                                        ...
                                        await button_interaction.response.send_message(
                                            f"{pimp.deniedIcon} An error occurred while deleting the administrator.",
                                            ephemeral=True
                                        )

                                async def cancel_callback(button_interaction: discord.Interaction):
                                    cancel_embed = discord.Embed(
                                        title=f"{pimp.deniedIcon} Process Canceled",
                                ...
                                await select_interaction.response.send_message(
                                    f"{pimp.deniedIcon} An error occurred during processing.",
                                    ephemeral=True
                                )
                        ...
                        if not interaction.response.is_done():
                            await interaction.response.send_message(
                                f"{pimp.deniedIcon} An error occurred during the administrator deletion process.",
                                ephemeral=True
                            )
            ...
            try:
                with sqlite3.connect('db/settings.sqlite') as settings_db:
                    ...
                    with sqlite3.connect('db/alliance.sqlite') as alliance_db:
                        ...
                        embed = discord.Embed(
                            title=f"{pimp.avatarIcon} Admin Alliance Permissions",
                            description=(
                        ...
                        async def select_callback(select_interaction: discord.Interaction):
                            try:
                                ...
                                confirm_embed = discord.Embed(
                                    title=f"{pimp.warnIcon} Confirm Permission Removal",
                                    description=(
                                ...
                                async def confirm_callback(confirm_interaction: discord.Interaction):
                                    try:
                                        ...
                                        if success:
                                            success_embed = discord.Embed(
                                                title=f"{pimp.verifiedIcon} Permission Removed",
                                                description=(
            ...
            try:
                ...
                if not admins:
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} No administrators found in the system.", 
                        ephemeral=True
                    )
                    return

                admin_list_embed = discord.Embed(
                    title=f"{pimp.avatarIcon} Administrator List",
                ...
                for admin_id, is_initial in admins:
                    try:
                        ...
                        admin_info = (
                            f"{pimp.fidIcon} **ID:** {admin_id}\n"
                            f"{f'{pimp.avatarOldIcon} **Role:** Global Admin' if is_initial == 1 else f'{pimp.avatarIcon} **Role:** Server Admin'}\n"
                            f"{pimp.allianceIcon} **Access Type:** {'All Alliances' if is_initial == 1 else 'Server + Special Access'}\n"
                        )
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} An error occurred while loading administrator list.",
                        ephemeral=True
                    )
            ...
            try:
                ...
                if database_cog:
                    ...
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} Database transfer module not loaded.", 
                        ephemeral=True
                    )
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} An error occurred while transferring the database.",
                        ephemeral=True
                    )
            ...
            try:
                ...
                if not current_version or not new_version:
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} Failed to check for updates. Please try again later.", 
                        ephemeral=True
                    )
                    return

                main_embed = discord.Embed(
                    title=f"{pimp.robotIcon} Bot Update Status",
                    color=pimp.emColor1 if not updates_needed else pimp.emColor4
                )
                ...
                if updates_needed:
                    main_embed.add_field(
                        name="Status",
                        value=f"{pimp.robotIcon} **Update Available**",
                        inline=True
                    )
                    ...
                    main_embed.add_field(
                        ...
                        value=(
                            ...
                            f"{pimp.robotIcon} **Restart the bot** (main.py)\n"
                            f"{pimp.verifiedIcon} Accept the update when prompted\n\n"
                    ...
                    main_embed.add_field(
                        name="Status",
                        value=f"{pimp.verifiedIcon} **Up to Date**",
                        inline=True
                    )
                ...
                if not interaction.response.is_done():
                    await interaction.response.send_message(
                        f"{pimp.deniedIcon} An error occurred while checking for updates.",
                        ephemeral=True
                    )
        ...
        try:
            embed = discord.Embed(
                ...
                description=(
                    ...
                    f"{pimp.settingsIcon} **Add Administrator**\n"
            ...
            if not interaction.response.is_done():
                await interaction.response.send_message(
                    f"{pimp.deniedIcon} An error occurred while showing the menu.",
                    ephemeral=True
                )
    ...
    async def show_control_settings_menu(self, interaction: discord.Interaction):
        ...
        try:
            ...
            if not alliances:
                await interaction.response.send_message(
                    f"{pimp.deniedIcon} No alliances found. Please create an alliance first.",
                    ephemeral=True
                )
                return
...
class ControlSettingsView(discord.ui.View):
    ...
    def setup_components(self):
        ...
        self.auto_remove_button = discord.ui.Button(
            ...
            style=discord.ButtonStyle.secondary if self.auto_remove else discord.ButtonStyle.secondary,
            emoji=f"{pimp.deleteIcon}",
        ...
        if self.auto_remove and self.selected_alliance:
            self.notify_button = discord.ui.Button(
                ...
                style=discord.ButtonStyle.secondary,
                emoji=f"{pimp.messageIcon}" if not self.notify_on_transfer else f"{pimp.messageNoIcon}",
                row=1
            )
    ...
    async def update_view(self, interaction: discord.Interaction):
        ...
        if self.selected_alliance:
            ...
            status_emoji = f"{pimp.verifiedIcon}" if self.auto_remove else f"{pimp.deniedIcon}"
            status_text = "Enabled" if self.auto_remove else "Disabled"
            notify_emoji = f"{pimp.messageIcon}" if self.notify_on_transfer else f"{pimp.messageNoIcon}"
            ...
            embed = discord.Embed(
                ...
                color=pimp.emColor3 if self.auto_remove else pimp.emColor2
            )
        else:
    ...
    async def alliance_selected(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.response.send_message(
                f"{pimp.deniedIcon} An error occurred while selecting the alliance.",
                ephemeral=True
            )
    ...
    async def toggle_auto_removal(self, interaction: discord.Interaction):
        ...
        try:
            ...
            await interaction.response.send_message(
                f"{pimp.deniedIcon} An error occurred while updating the setting.",
                ephemeral=True
            )
    ...
    async def back_to_bot_operations(self, interaction: discord.Interaction):
        ...
        try:
            ...
            if bot_ops:
                ...
                await interaction.response.send_message(
                    f"{pimp.deniedIcon} Unable to return to bot operations menu.",
                    ephemeral=True
                )
        except Exception as e:
