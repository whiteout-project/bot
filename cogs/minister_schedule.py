            ...
            if minister_menu_cog and self.context.endswith("channel"):
                ...
                embed = discord.Embed(
                    ...
                    description=(
                        ...
                        f"### Channel Types\n"
                        f"{pimp.divider1}\n\n"
                        f"{pimp.constructionIcon} **Construction Channel** - Shows available Construction Day slots\n"
                        f"{pimp.researchIcon} **Research Channel** - Shows available Research Day slots\n"
                        f"{pimp.trainingIcon} **Training Channel** - Shows available Training Day slots\n"
        ...
        try:
            ...
            embed = discord.Embed(
                ...
                description=f"Are you sure you want to remove all minister appointment slots for: {appointment_type}?\n"
                            f"**{pimp.warnIcon} This action cannot be undone and all names will be removed {pimp.warnIcon}**.\n"
