...
with sqlite3.connect('db/pimpsettings.sqlite') as pimpsettings_db:
    ...
    targetIcon = theme[24] if theme else elseEmoji
    redeemIcon = theme[25] if theme else elseEmoji
    membersIcon = theme[26] if theme else elseEmoji
    anounceIcon = theme[27] if theme else elseEmoji
    averageIcon = theme[28] if theme else elseEmoji
    hashtagIcon = theme[29] if theme else elseEmoji
    messageIcon = theme[30] if theme else elseEmoji
    settingsIcon = theme[31] if theme else elseEmoji
    settings2Icon = theme[32] if theme else elseEmoji
    hourglassIcon = theme[33] if theme else elseEmoji
    alarmClockIcon = theme[34] if theme else elseEmoji
    magnifyingIcon = theme[35] if theme else elseEmoji
    checkGiftCodeIcon = theme[36] if theme else elseEmoji
    deleteGiftCodeIcon = theme[37] if theme else elseEmoji
    addGiftCodeIcon = theme[38] if theme else elseEmoji
    processingIcon = theme[39] if theme else elseEmoji
    verifiedIcon = theme[40] if theme else elseEmoji
    questionIcon = theme[41] if theme else elseEmoji
    transferIcon = theme[42] if theme else elseEmoji
    multiplyIcon = theme[43] if theme else elseEmoji
    divideIcon = theme[44] if theme else elseEmoji
    deniedIcon = theme[45] if theme else elseEmoji
    deleteIcon = theme[46] if theme else elseEmoji
    exportIcon = theme[47] if theme else elseEmoji
    importIcon = theme[48] if theme else elseEmoji
    retryIcon = theme[49] if theme else elseEmoji
    totalIcon = theme[50] if theme else elseEmoji
    infoIcon = theme[51] if theme else elseEmoji
    warnIcon = theme[52] if theme else elseEmoji
    addIcon = theme[53] if theme else elseEmoji
    dividerEmojiStart1 = theme[54].split(",") if theme else [elseEmoji]
    dividerEmojiPattern1 = theme[55].split(",") if theme else [elseEmoji]
    dividerEmojiEnd1 = theme[56].split(",") if theme else [elseEmoji]
    dividerLength1 = theme[57] if theme else 9
    dividerEmojiStart2 = theme[58].split(",") if theme else [elseEmoji]
    dividerEmojiPattern2 = theme[59].split(",") if theme else [elseEmoji]
    dividerEmojiEnd2 = theme[60].split(",") if theme else [elseEmoji]
    dividerLength2 = theme[61] if theme else 9
    emColorString1 = theme[62] if theme else "#FFFFFF"
    emColorString2 = theme[63] if theme else "#FFFFFF"
    emColorString3 = theme[64] if theme else "#FFFFFF"
    emColorString4 = theme[65] if theme else "#FFFFFF"
