    ...
    async def fetch_theme_info(self, interaction: discord.Interaction, themename: str):
        try:
            ...
            if themename == "default":
                lines = [
                    f"allianceOldIcon = {allianceOldIcon} = https://discord.com/assets/fa2c28d64be33d41.svg",
                    f"avatarOldIcon = {avatarOldIcon} = https://discord.com/assets/5b12dce3a467ed97.svg",
                    f"stoveOldIcon = {stoveOldIcon} = https://discord.com/assets/a7bd71d6389d0dfe.svg",
                    f"stateOldIcon = {stateOldIcon} = https://discord.com/assets/864e0e4584241547.svg",
                    f"allianceIcon = {allianceIcon} = https://discord.com/assets/fa2c28d64be33d41.svg",
                    f"avatarIcon = {avatarIcon} = https://discord.com/assets/5b12dce3a467ed97.svg",
                    f"stoveIcon = {stoveIcon} = https://discord.com/assets/a7bd71d6389d0dfe.svg",
                    f"stateIcon = {stateIcon} = https://discord.com/assets/25e48a1e493a8668.svg",
                    f"listIcon = {listIcon} = https://discord.com/assets/9b50a2e1be3cd515.svg",
                    f"fidIcon = {fidIcon} = https://discord.com/assets/e205e5f16fab825d.svg",
                    f"timeIcon = {timeIcon} = https://discord.com/assets/1a3e5bc356c4308b.svg",
                    f"homeIcon = {homeIcon} = https://discord.com/assets/e7f086418e908e40.svg",
                    f"num1Icon = {num1Icon} = https://discord.com/assets/83f7cb2c2f4230cd.svg",
                    f"num2Icon = {num2Icon} = https://discord.com/assets/f36ae3caed2a0bae.svg",
                    f"num3Icon = {num3Icon} = https://discord.com/assets/a20044fbde269579.svg",
                    f"newIcon = {newIcon} = https://discord.com/assets/903e44646bb0b466.svg",
                    f"pinIcon = {pinIcon} = https://discord.com/assets/0da00b0fec31ced4.svg",
                    f"giftIcon = {giftIcon} = https://discord.com/assets/949f113339307625.svg",
                    f"giftsIcon = {giftsIcon} = https://discord.com/assets/f1382a93639744a7.svg",
                    f"alertIcon = {alertIcon} = https://discord.com/assets/fb6fd920c79bd504.svg",
                    f"robotIcon = {robotIcon} = https://discord.com/assets/b8dafcbec499ac71.svg",
                    f"crossIcon = {crossIcon} = https://discord.com/assets/fa2c28d64be33d41.svg",
                    f"heartIcon = {heartIcon} = https://discord.com/assets/453654b9f13ea463.svg",
                    f"total2Icon = {total2Icon} = https://discord.com/assets/51aa82833b5f08b5.svg",
                    f"shieldIcon = {shieldIcon} = https://discord.com/assets/51cc7794c9a923de.svg",
                    f"targetIcon = {targetIcon} = https://discord.com/assets/8683903b8675f909.svg",
                    f"redeemIcon = {redeemIcon} = https://discord.com/assets/c365d5d32bba07d4.svg",
                    f"membersIcon = {membersIcon} = https://discord.com/assets/be8706c9515e4e6e.svg",
                    f"anounceIcon = {anounceIcon} = https://discord.com/assets/7401aa22d4169631.svg",
                    f"averageIcon = {averageIcon} = https://discord.com/assets/a59b48874be63ed4.svg",
                    f"hashtagIcon = {hashtagIcon} = https://discord.com/assets/81224497b397e84f.svg",
                    f"messageIcon = {messageIcon} = https://discord.com/assets/6446faea65f88f9b.svg",
                    f"supportIcon = {supportIcon} = https://discord.com/assets/6e1e6f0796462dc1.svg",
                    f"settingsIcon = {settingsIcon} = https://discord.com/assets/7afdc0163bb3fba3.svg",
                    f"settings2Icon = {settings2Icon} = https://discord.com/assets/7afdc0163bb3fba3.svg",
                    f"hourglassIcon = {hourglassIcon} = https://discord.com/assets/07910dea69f5d269.svg",
                    f"messageNoIcon = {messageNoIcon} = https://discord.com/assets/e5278532283d7271.svg",
                    f"alarmClockIcon = {alarmClockIcon} = https://discord.com/assets/d9505466edba0bff.svg",
                    f"magnifyingIcon = {magnifyingIcon} = https://discord.com/assets/74f0a67afb481b21.svg",
                    f"checkGiftCodeIcon = {checkGiftCodeIcon} = https://discord.com/assets/43b7ead1fb91b731.svg",
                    f"deleteGiftCodeIcon = {deleteGiftCodeIcon} = https://discord.com/assets/7b47ccd346102b2a.svg",
                    f"addGiftCodeIcon = {addGiftCodeIcon} = https://discord.com/assets/15f799a915e5de90.svg",
                    f"processingIcon = {processingIcon} = https://discord.com/assets/e541f62450f233be.svg",
                    f"verifiedIcon = {verifiedIcon} = https://discord.com/assets/43b7ead1fb91b731.svg",
                    f"questionIcon = {questionIcon} = https://discord.com/assets/881ed827548f38c6.svg",
                    f"transferIcon = {transferIcon} = https://discord.com/assets/e541f62450f233be.svg",
                    f"multiplyIcon = {multiplyIcon} = https://discord.com/assets/66932d1dab5dbc04.svg",
                    f"divideIcon = {divideIcon} = https://discord.com/assets/8c01b18c49b9a764.svg",
                    f"deniedIcon = {deniedIcon} = https://discord.com/assets/4f584fe7b12fcf02.svg",
                    f"deleteIcon = {deleteIcon} = https://discord.com/assets/e01b1b8006e1985f.svg",
                    f"exportIcon = {exportIcon} = https://discord.com/assets/9a72e30b860ad150.svg",
                    f"importIcon = {importIcon} = https://discord.com/assets/343e2b25ac51d920.svg",
                    f"retryIcon = {retryIcon} = https://discord.com/assets/e541f62450f233be.svg",
                    f"totalIcon = {totalIcon} = https://discord.com/assets/51aa82833b5f08b5.svg",
                    f"infoIcon = {infoIcon} = https://discord.com/assets/c263a344ff649ead.svg",
                    f"warnIcon = {warnIcon} = https://discord.com/assets/fb6fd920c79bd504.svg",
                    f"addIcon = {addIcon} = https://discord.com/assets/15f799a915e5de90.svg",
